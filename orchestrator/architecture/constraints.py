...
_CONSTRAINT_CATALOG: list[dict] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "   This catches the deadlock class where the two sides of a feedback "
            "loop disagree on backpressure ownership.\n\n"
    ...
    },
    {
        ...
        "description": (
            ...
            "depth. A scheduler FIFO sized below the contract's stall window "
            "deadlocks the chip a few percent into its input; this constraint "
            "catches that class of bug before DV.\n\n"
